  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        clearTimeout(_modals__WEBPACK_IMPORTED_MODULE_5__["timeout"]);
        window.removeEventListener('scroll', _modals__WEBPACK_IMPORTED_MODULE_5__["showModalByScroll"]);
      }).catch(function (e) {
        console.log(e);
...
function openModal(selector) {
  ...
  document.body.style.overflow = "hidden"; // use bootstrap class
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ""; // use bootstrap class
      //document.body.classList.remove('modal-open')
    });
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeClickOverlay)
        /* Якщо клікаєм за межі св=амого модального вікна */
        {
          windows.forEach(function (window) {
            window.style.display = 'none';
          });
...
var showModalByScroll = function showModalByScroll() {
  ...
  window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
    var bottomModalTimerId = setTimeout(function () {
      return openModal('.popup_engineer');
