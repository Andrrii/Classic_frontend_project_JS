...
var forms = function forms(state) {
  ...
  var postData = function postData(url, data) {
    var load, loadMessage, res;
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            load = document.querySelector('.status');
            loadMessage = document.createElement('img');
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      if (item.getAttribute('data-calc') === 'end') {
        /* Якщо форма-калькулятор то добавляєм ще дані */
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        clearTimeout(_modals__WEBPACK_IMPORTED_MODULE_12__["timeout"]);
        window.removeEventListener('scroll', _modals__WEBPACK_IMPORTED_MODULE_12__["showModalByScroll"]);
      }).catch(function (e) {
        console.log(e);
...
var images = function images() {
  // Збільшуєм зображення при кліку на них
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: default, timeout, showModalByScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function openModal(selector, scroll) {
  ...
  document.body.style.marginRight = "".concat(scroll, "px"); // use bootstrap class
...
var modals = function modals(state) {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = "";
      document.body.style.marginRight = "0px"; // use bootstrap class
      //document.body.classList.remove('modal-open')
    });
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeClickOverlay)
        /* Якщо клікаєм за межі самого модального вікна */
        {
          windows.forEach(function (window) {
            window.style.display = 'none';
          });
  ...
  function calcScroll() {
    /* Коли викликаєм модальне вікно то скрол заміняється на пустий блок  */
    var div = document.createElement('div');
    ...
    var scrollWidth = div.offsetWidth - div.clientWidth; // -- Отримуєм ширину прокрутки 
...
var showModalByScroll = function showModalByScroll() {
  ...
  window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
    var bottomModalTimerId = setTimeout(function () {
      return openModal('.popup_engineer', scroll);
    }, 2500); //    console.log(bottomModalTimerId)
...
function timer(id, deadline) {
  function getTimeRemaining(endtime) {
    /* Отримує різницю між датами */
    var t = Date.parse(endtime) - new Date(),
        days = Math.floor(t / (1000 * 60 * 60 * 24)),

    /* floor - округлює до найближчого цілого */
  ...
  function setClock(selector, endtime) {
    /* встановлюєм таймер на нашу сторінку */
    ...
    updateClock();
    /* викликаєм функцію,щоб значення зразу запсувались на сторінку */
